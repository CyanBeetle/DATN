...
const TrafficVolumeChart = ({ labels = [], data = [] }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Set up colors
      const primaryColor = 'rgba(24, 144, 255, 0.8)';
      const secondaryColor = 'rgba(82, 196, 26, 0.6)';
        ...
        data: {
          ...
          datasets: [
            ...
            },
            {
              ...
              borderColor: secondaryColor.replace('0.6', '1'),
              borderWidth: 1,
              borderRadius: 4,
              barPercentage: 0.7,
              categoryPercentage: 0.8
            ...
            tooltip: {
              ...
              callbacks: {
                label: function(context) {
                  ...
                  label += context.parsed.y + ' vehicles/h';
                  return label;
                }
              }
            }
      ...
      console.error('Error creating traffic volume chart:', err);
      setError('Failed to render traffic volume chart.');
    }
  ...
  if (!labels.length || !data.length) {
    return (
      <div style={{ height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <Empty description="No traffic volume data available" />
      </div>
    );
  }
